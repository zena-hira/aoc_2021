...
from solutions.aoc_17 import star_1, star_2
...
#print('Problem 17 A Sample: ' + str(star_1(sample)))
#print('Problem 17 A: ' + str(star_1(input_)))
print('Problem 17 B Sample: ' + str(star_2(sample)))
print('Problem 17 B: ' + str(star_2(input_)))